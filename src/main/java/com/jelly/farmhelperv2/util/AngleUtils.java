...
public class AngleUtils {
    ...
    public static Rotation getRotation(Entity entity, boolean randomness) {
    ...
    public static Rotation getRotation(Vec3 vec3, boolean randomness) {
    ...
    private static Rotation getRotationTo(double diffX, double diffY, double diffZ, boolean randomness) {
        double dist = Math.sqrt(diffX * diffX + diffZ * diffZ);

        float pitch = (float) -Math.atan2(dist, diffY);
        float yaw = (float) Math.atan2(diffZ, diffX);
        pitch = (float) MathHelper.wrapAngleTo180_double((pitch * 180F / Math.PI + 90) * -1) + (randomness ? (float) (Math.random() * 6 - 3f) : 0);
        yaw = (float) MathHelper.wrapAngleTo180_double((yaw * 180 / Math.PI) - 90) + (randomness ? (float) (Math.random() * 6 - 3f) : 0);
